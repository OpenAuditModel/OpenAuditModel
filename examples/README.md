...
[OpenAuditModel Audit Event Schema 1.0](../schemas/v1.0/audit-event.schema.json). Every file in
...
| [order-api-publish.json](valid/order-api-publish.json)                             | `order.submission.accept`         | HTTP entry point with request, trace and correlation identifiers, and the parent span added in 1.0 |
