...
const CATALOGUE = [
  ...
  // Canonical schemas
  [
    "openauditmodel://schema/audit-event/1.0",
    "schemas/v1.0/audit-event.schema.json",
    SCHEMA_JSON,
    "Canonical Audit Event Schema 1.0",
    "The canonical JSON Schema Draft 2020-12 definition of an audit event, version 1.0: stable, and what producers should emit.",
  ],
  [
    ...
    "The pre-1.0 definition of an audit event, kept for events written against it. Validation selects the schema by the version an event declares.",
  ],
  [
  ...
  [
    "openauditmodel://semantic-conventions/message-brokers",
    "semantic-conventions/message-brokers.md",
    MARKDOWN,
    "Semantic Conventions: Message Brokers",
    "The control plane of a broker: destinations, access, quotas, offsets and replay. The data plane is not an audit trail.",
  ],
  [
    "openauditmodel://semantic-conventions/secrets-and-keys",
    "semantic-conventions/secrets-and-keys.md",
    MARKDOWN,
    "Semantic Conventions: Secrets and Keys",
    "Secret, key and certificate lifecycle, emergency access, and the material that must never be recorded.",
  ],
  [
    "openauditmodel://semantic-conventions/financial-transactions",
    "semantic-conventions/financial-transactions.md",
    MARKDOWN,
    "Semantic Conventions: Financial Transactions",
    "Movements of money, limits and reconciliation, and why the audit event is not the payment record.",
  ],
  [
    "openauditmodel://semantic-conventions/backup-and-recovery",
    "semantic-conventions/backup-and-recovery.md",
    MARKDOWN,
    "Semantic Conventions: Backup and Recovery",
    "Backup, restore and recovery operations, the start-and-completion pair, and early deletion.",
  ],
  [
    "openauditmodel://semantic-conventions/customer-and-account",
    "semantic-conventions/customer-and-account.md",
    MARKDOWN,
    "Semantic Conventions: Customer and Account",
    "Business parties and business accounts, and the boundary that keeps them out of the identity vocabulary.",
  ],
  [
  ...
  [
    "openauditmodel://profiles/identity-and-access-management/0.2",
    "profiles/identity-and-access-management/profile.json",
    JSON_MIME,
    "Identity and Access Management Profile 0.2",
    "The enforceable IAM profile definition: eleven declarative rules.",
  ],
  [
    "openauditmodel://profiles/document-management/0.2",
    "profiles/document-management/profile.json",
    JSON_MIME,
    "Document Management Profile 0.2",
